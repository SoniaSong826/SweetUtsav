...
import { FlatList, StyleSheet, View, TextInput, TouchableOpacity, Dimensions } from 'react-native';
...
// const storeUrl = [
// 	{ caroline: 'https://carolinesprings.sweetutsav.com.au/' },
// 	{ melbourne: 'https://melbourne.sweetutsav.com.au/' },
// 	{ tarneit: 'https://tarneit.sweetutsav.com.au/' },
// 	{ lyndhurst: 'https://lyndhurst.sweetutsav.com.au/' },
// 	{ brisbane: 'https://brownsplains.sweetutsav.com.au/' },
// 	{ sydney: 'https://sydney.sweetutsav.com.au/' },
// ];
...
console.warn(storeUrl);
export default class MenuWoo extends Component {
	constructor(props) {
		super(props);
		((this.categoryVisible = props.categoryVisible), (this.searchBarVisible = props.searchBarVisible)),
			(this.state = {
				data: [],
				loading: true,
				selectedItem: 95,
						...
						<FlatList
							...
							renderItem={({ item }) => (
								<CategoryButton
									title={item.title}
									key={item.id}
									color={this.state.selectedItem === item.id ? 'primary' : 'secondary'}
									onPress={() => {
