        ...
        <ScrollView contentContainerStyle={styles.container}>
          ...
          >
            <Text style={styles.text}>
              ...
              authentic Indian savories and sweets and hence the motto{" "}
              <Text style={styles.boldOrangeText}>
                “When only the best will do”
              </Text>{" "}
              Sweet Utsav does not compromise on ingredients and procedure and
              uses only the finest of ingredients and time-tested procedures
              that deliver a quality product.
            </Text>
          </View>
          <TouchableOpacity
            activeOpacity={0.8}
          ...
          >
            <Text style={styles.text}>
              ...
              Sweet Utsav was born from the same person who pursued his dream of
              setting up Australia’s largest sweet and snacks manufacturing
              factory at Seven Hills, Sydney. It will cater to distribute sweets
              to selected outlets in Sydney and Canberra.
            </Text>
          </View>
          <TouchableOpacity
            activeOpacity={0.8}
            ...
            style={styles.Btn}
          >
            <Text style={styles.title}>Management Team</Text>
            <MaterialCommunityIcons
              name="chevron-down"
              size={30}
              color={colors.secondary}
          ...
          >
            <Text style={styles.text}>
              <View style={styles.photoWithName}>
                <Image
                  style={styles.photo}
                  source={{
                    uri: "http://sweetutsav.com.au/images/owner_img.png",
                  }}
                ></Image>
                <Text style={styles.boldText}>Surya Prakash Revu </Text>
              </View>
              {"\n"}Founder and CEO Prakash has devoted his life in getting the
              best premium sweets to Australia and with a decade of experience,
              having successfully set up Melbourne largest Sweet and Snack
              Manufacturers has created “Sweet Utsav” as his largest sweets
              ...
              <View style={styles.photoWithName}>
                <Image
                  style={styles.photo}
                  source={{
                    uri: "http://sweetutsav.com.au/images/brian_img.png",
                  }}
                ></Image>
                <Text style={styles.boldText}>Brian Pereira </Text>
              </View>
              {"\n"}Brian has more than 25 years of business expertise and has
              been successfully involved with setting up large corporate and
              hospitality businesses over more than two decades in Melbourne.
              {"\n"}
              {"\n"}
              <Image
                style={styles.photo}
                source={{
                  uri: "http://sweetutsav.com.au/images/chef_img.png",
                }}
              ></Image>
              <View style={styles.photoWithName}>
                <Text style={styles.boldText}>Chefs</Text>
              </View>
              {"\n"}The chefs at Sweet Utsav have decades of experience in the
              Sweet and Snack industry in India. It is with this rich experience
              that we at Sweet Utsav offer the best quality sweets and snacks.
              Our expert sweet makers have experience in making sweets and
              snacks from all regions of the sub-continent. Our team is
              passionate about providing excellent customer service and will
              assist consumers in making choices. Our chefs have also conducted
              extensive research in the art of creating various innovative
              sweets with improved processes and quality. We continue to keep
              pace with modern trends and analyse the needs, demands and desire
              of our customers.
            </Text>
          </View>
          <TouchableOpacity
